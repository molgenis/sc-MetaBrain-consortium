...
parser.add_argument("--method", required=False, type=str, default="weighted_lm", choices=["lm", "corr", "weighted_lm", "weighted_corr"], help="")
...
def load_counts(counts_fpath, feature_name="HGNC"):
