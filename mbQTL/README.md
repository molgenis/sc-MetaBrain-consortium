 ...
 * `annotation`: `genes.gtf` of your alignment reference. If the file does not end with `.gtf` it assumes it is a mbQTL annotation file: tab seperated with `Gene`, `GeneSymbol`, `Chr`, `ChrStart`, `ChrEnd`, and `Strand` columns.
